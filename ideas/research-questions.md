...
- Does the 7-\(U\) \(B_3\) tensor pattern generalize to the whole bottom-disciplined \(B_N\) family, and can same-order full residuation weaken the \(U\)-absorbing assumption?
