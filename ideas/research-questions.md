...
- Do the checked non-\(U\)-absorbing full-residuated tensors for \(B_3\) and
  \(B_4\) fit a uniform \(B_N\) construction, or do they split into
  depth-specific search artifacts?
