...
- **[Resolved]** Find bottom-disciplined replacements for G2 without FG2,
  ...
  `FFFTTTTT`.
- **[New]** Find a bottom-disciplined replacement witness for G2+FG2 without
  FP-synt, or prove bottom discipline plus the current finite preAPS assumptions
  force a syntactic fixed point in that fragment.
