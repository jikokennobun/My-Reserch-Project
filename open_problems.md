...
- **[New]** Find bottom-disciplined replacement witnesses for the separations
  lost under pure order enforcement: G2 without FG2, G2+FP without FG2,
  G2+FG2 without FP, and arbitrary finite first-true nFG2 depth.
