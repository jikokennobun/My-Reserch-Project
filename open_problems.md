...
- **[Partially resolved]** Find a less top-collapsing tensor for the \(B_N\)
  ...
  a large part of the nonzero non-unit product table.
...
- **[New]** Generalize the 7-\(U\) tensor pattern to \(B_N\), or prove it is
  depth-specific; separately test whether same-order full residuation can
  weaken the \(U\)-absorbing assumption.
