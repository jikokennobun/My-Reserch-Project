...
- **[Resolved]** Prove the uniform \(B_N\) top-absorbing residuation lemma:
  ...
  sent to \(U\).
- **[New]** Find a less top-collapsing tensor for the \(B_N\) family, or prove
  that any same-order full-residuated expansion must collapse a large part of
  the nonzero non-unit product table.
