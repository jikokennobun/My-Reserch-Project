...
- **[New]** Test bottom discipline across the finite G2-ZOO and the \(D_N\)
  hierarchy: which existing separations survive after enforcing
  \(\bot\le x\) for all elements, and which witnesses collapse or become
  residuated/lattice-like?
